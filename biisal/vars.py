...
bisal_channel = "https://t.me/Af_cinemax"
...
class Var(object):
    ...
    UPDATES_CHANNEL = str(getenv('UPDATES_CHANNEL', 'AF_cinemas')) 
    BANNED_CHANNELS = list(set(int(x) for x in str(getenv("BANNED_CHANNELS", "-1002213359277")).split()))   
